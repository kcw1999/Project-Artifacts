Function ADHealthReport {
    ...
    # Modify Replication Status collection to include TransportType and LastAttemptedSync
    $replicationStatus = Get-SafeADData {
        Get-ADReplicationPartnerMetadata -Target $domain.Name | Select-Object Source, Partner, Partition, 
        @{Name="TransportType"; Expression={$_.TransportType -as [string]}}, 
        @{Name="LastSyncResult"; Expression={$_.LastSyncResult -as [string]}}, 
        @{Name="LastAttemptedSync"; Expression={$_.LastAttemptedSync -as [string]}}
    }
    ...
    # Trust Relationships and GPO Info
